...
import { ProgressRing, MacroBar } from '@/components/ui/MealComponents';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 pt-16 space-y-8">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="lg:col-span-5 md:col-span-4">
            <div className="glass-panel rounded-4xl p-8 h-full flex flex-col justify-center items-center text-center relative overflow-hidden group">
          ...
          <motion.div variants={itemVariants} className="lg:col-span-4 md:col-span-2 space-y-6 flex flex-col">
            <div className="glass-panel rounded-4xl p-8 flex-1">
            ...
            <div className="grid grid-cols-2 gap-6 h-32">
              <div className="glass-panel rounded-3xl p-4 flex flex-col justify-center items-center hover:-translate-y-1 transition-transform">
          ...
          <motion.div variants={itemVariants} className="lg:col-span-3 md:col-span-2">
            <div className="glass-panel rounded-4xl p-8 h-full flex flex-col">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {meals.map((meal, idx) => (
                <motion.div 
                  key={idx}
                  whileHover={{ y: -5 }}
                  className="glass-panel rounded-4xl p-4 flex gap-4 items-center group cursor-pointer"
                >
                  <div className="w-24 h-24 rounded-3xl overflow-hidden bg-cream-border">
              ...
              <div className="glass-panel rounded-4xl p-6 flex flex-col justify-center items-center text-center border-dashed border-2 border-sage-light bg-transparent hover:bg-sage-main/5 cursor-pointer transition-colors">
